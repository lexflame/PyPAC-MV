...
class ItemTask(QWidget):
    ...
    def setupUi(self, title, priority, deadline, data):
        ...
        """ Область Data View === start """
        header_label = QLabel()
        header_label.setStyleSheet("border:1px solid white;")
        self.box_item_layout.addWidget(header_label, stretch=25)
        """ Область Data View === end """

        """ Область Action === end """
        self.action_label = QLabel()
        self.action_label.setStyleSheet("border:1px solid blue;")
        self.box_item_layout.addWidget(self.action_label, stretch=4)
        """ Область Action === start """

        """ Область Spoiler Desc === end """
        desc_label = QLabel()
        desc_label.setStyleSheet("border:1px solid blue;")
        self.box_item_layout.addWidget(desc_label, stretch=1)
        """ Область Spoiler Desc === start """
